...
RSpec.describe PoolsController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested pool as @pool" do
      ...
      expect(assigns(:pool)).to eq(pool)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created pool as @pool" do
        post :create, {:pool => valid_attributes}, valid_session
        expect(assigns(:pool)).to be_a(Pool)
        expect(assigns(:pool)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pool as @pool" do
        post :create, {:pool => invalid_attributes}, valid_session
        expect(assigns(:pool)).to be_a_new(Pool)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested pool" do
        pool = Pool.create! valid_attributes
        put :update, {:id => pool.to_param, :pool => new_attributes}, valid_session
        pool.reload
    ...
    describe "with invalid params" do
      it "assigns the pool as @pool" do
        pool = Pool.create! valid_attributes
        put :update, {:id => pool.to_param, :pool => invalid_attributes}, valid_session
        expect(assigns(:pool)).to eq(pool)
      end
